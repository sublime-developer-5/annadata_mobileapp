...
import 'package:annadata/Test/recieveDataTest.dart';
...
class FarmerRegistrationFirstpage extends StatefulWidget {
  const FarmerRegistrationFirstpage({Key? key}) : super(key: key);

  @override
  State<FarmerRegistrationFirstpage> createState() =>
      _FarmerRegistrationFirstpageState();
}

class _FarmerRegistrationFirstpageState
    extends State<FarmerRegistrationFirstpage> {
  ...
  void setData() async {
    ...
    log(firstName.text);
    log(croppedImage == null ? "" : croppedImage!.path);
    log(email_Id.text);
    log(_countryCode);
    log(phone_number.text);
    log(_newPassword.text);
    log(dateinput.text);
    log(gender.toString());
                          ...
                          children: <Widget>[
                            CircleAvatar(
                                ...
                                backgroundImage: croppedImage == null
                                    ...
                                    :
                                    // NetworkImage(imageFile.toString())
                                    //     as ImageProvider
  ...
  void _sendDataToSecondScreen(BuildContext context) {
    //String textToSend = firstName.text, email_Id.text;
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => RetriveDataTest(
                  fname: firstName.text,
                  email: email_Id.text,
                  phone: phone_number.text,
                  password: _newPassword.text,
                  dob: dateinput.text,
                  contry_code: _countryCode,
                  profImage: TestImagePicker,
                  radioParam: gender.toString(),
                  addressFarmer: addressController.text,
                )));
  }
      ...
      if (success == true) {
        Future.delayed(const Duration(seconds: 1), () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => FarmerRegSecondPage()));
        });
      }
    } catch (e) {
      print('e');
