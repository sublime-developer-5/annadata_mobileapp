...
class LogisticRegSecondPage extends StatefulWidget {
  const LogisticRegSecondPage({Key? key}) : super(key: key);

  @override
  State<LogisticRegSecondPage> createState() => _LogisticRegSecondPageState();
}

class _LogisticRegSecondPageState extends State<LogisticRegSecondPage> {
  ...
  void getData() async {
    ...
    final List<String>? items = prefs.getStringList('registerItemLogistics1');
                            ...
                            child: ElevatedButton(
                                onPressed: () {
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    //   MaterialPageRoute(
                                    //     builder: (_) => LogisticRegSecondPage(),
                                    //   ),
                                    // );
                                  }
                                },
